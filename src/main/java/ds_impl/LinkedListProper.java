...
public class LinkedListProper<AnyType> implements Iterable<AnyType> {
    private Node<AnyType> head;

    /** Constructs an empty list*/
    public LinkedListProper() {
        head = null;
    }
     ...
     * Complexity: O(n^2)
     */
    public LinkedListProper<AnyType> copy1() {
        LinkedListProper<AnyType> twin = new LinkedListProper<AnyType>();
        Node<AnyType> tmp = head;
        while (tmp != null) {
     ...
     * Complexity: O(n)
     */
    public LinkedListProper<AnyType> copy2() {
        LinkedListProper<AnyType> twin = new LinkedListProper<AnyType>();
        Node<AnyType> tmp = head;
        while (tmp != null) {
     ...
     * Complewxity: O(n)
     */
    public LinkedListProper<AnyType> reverse() {
        LinkedListProper<AnyType> list = new LinkedListProper<AnyType>();
        Node<AnyType> tmp = head;
        while (tmp != null) {
     ...
     * Complexity: O(n)
     */
    public LinkedListProper<AnyType> copy3() {
        LinkedListProper<AnyType> twin = new LinkedListProper<AnyType>();
        Node<AnyType> tmp = head;
    ...
    public static void main(String[] args) {
        LinkedListProper<String> list = new LinkedListProper<String>();
        list.addFirst("p");
        list.addFirst("a");
        list.addFirst("e");
        list.addFirst("h");
        ...
        LinkedListProper<String> twin = list.copy3();
